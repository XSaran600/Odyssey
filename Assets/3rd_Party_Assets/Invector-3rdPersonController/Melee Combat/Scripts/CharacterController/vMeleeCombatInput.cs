...
namespace Invector.vCharacterController
{
    ...
    public class vMeleeCombatInput : vThirdPersonInput, vIMeleeFighter
    {
        ...
        {
            return !isAttacking && !cc.customAction && !cc.isCrouching && cc.isGrounded && cc.GroundAngle() < cc.slopeLimit && cc.currentStamina >= cc.jumpStamina && !cc.isJumping && !cc.isRolling;
        }

        protected override bool RollConditions()
        {
            return (!cc.isRolling || cc.canRollAgain) && cc.input != Vector3.zero && !cc.customAction && cc.isGrounded && cc.currentStamina > cc.rollStamina && !cc.isJumping && !isAttacking && !cc.jumpingCooldown;
        }
