...
{
    [ExecuteInEditMode]
    [AddComponentMenu("BOXOPHOBIC/The Vegetation Engine/TVE Extras Volume")]
    public class TVEExtrasVolume : StyledMonoBehaviour
    {
        [StyledBanner(0.890f, 0.745f, 0.309f, "Extras Volume", "", "https://docs.google.com/document/d/145JOVlJ1tE-WODW45YoJ6Ixg23mFc56EnB_8Tbwloz8/edit#heading=h.jbyqjo5h6xs0")]
        ...
        [StyledMessage("Info", "Use the Baked Render option if you don't want to update Seasons or Overlay, Wetness, Size and Leaves mask elements in realtime! Set the Render Resolution to small values for minimal performance impact!", 0, 5)]
        public bool infoBaked = false;
        [StyledMessage("Info", "Use the Realtime Render option if you want to update the Overlay, Wetness, Size and Leaves mask elements in realtime.", 0, 5)]
        ...
        void OnDrawGizmos()
        {
            if (camGO != null)
            {
                Gizmos.color = new Color(0f, 0.5f, 1f, volumeVisibility);
        ...
        void InitCameraHDParameters()
        {
            ...
            camHD.backgroundColorHDR = new Color(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        void SetGlobalShaderParameters()
        {
            ...
            Shader.SetGlobalVector("TVE_ExtrasCoord", new Vector4(-globalUVsX, -globalUVsY, globalUVsZ, 0));
            Shader.SetGlobalTexture("TVE_ExtrasTex", renderTex);

            if (Application.isPlaying && renderMode == RenderMode.Baked)
            {
                Shader.SetGlobalTexture("TVE_ExtrasTex", bakedTex);
            }
            else
            {
                Shader.SetGlobalTexture("TVE_ExtrasTex", renderTex);
        ...
        void CreateEdgeGameObject()
        {
            ...
            edgeMaterial = Resources.Load<Material>("EdgeFadeExtras");
