	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 lerpResult1545_g17548 = lerp( packedInput.ase_texcoord5.xy , packedInput.interp03.xy , _DetailCoordMode);
				float2 Second_UVs17_g17548 = ( ( lerpResult1545_g17548 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				...
				half Mesh_DetailMask90_g17548 = packedInput.ase_color.b;
				float temp_output_989_0_g17548 = ( ( Mesh_DetailMask90_g17548 - 0.5 ) + _DetailMeshValue );
				half Blend_Source1540_g17548 = temp_output_989_0_g17548;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half3 Main_AlbedoRaw99_g17548 = (temp_output_51_0_g17548).rgb;
				half3 Main_AlbedoColored863_g17548 = Main_AlbedoRaw99_g17548;
				float2 lerpResult1545_g17548 = lerp( packedInput.ase_texcoord.xy , packedInput.ase_texcoord1.xy , _DetailCoordMode);
				float2 Second_UVs17_g17548 = ( ( lerpResult1545_g17548 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo153_g17548 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g17548 ) )).rgb;
				half3 Second_AlbedoColored1963_g17548 = Second_Albedo153_g17548;
				half Mesh_DetailMask90_g17548 = packedInput.ase_color.b;
		...
		Pass
		{
					...
					)
			{
				...
				float3 appendResult91_g18301 = (float3(temp_output_90_0_g18301 , 1.0));
				float3 Main_Normal137_g17548 = appendResult91_g18301;
				float2 lerpResult1545_g17548 = lerp( packedInput.ase_texcoord3.xy , packedInput.ase_texcoord4.xy , _DetailCoordMode);
				float2 Second_UVs17_g17548 = ( ( lerpResult1545_g17548 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				float4 tex2DNode145_g17548 = tex2D( _SecondNormalTex, Second_UVs17_g17548 );
				float2 appendResult88_g18256 = (float2(tex2DNode145_g17548.a , tex2DNode145_g17548.g));
				float2 temp_output_90_0_g18256 = ( (appendResult88_g18256*2.0 + -1.0) * _SecondNormalValue );
		...
		Pass
		{
						...
						)
			{
				...
				half3 Main_AlbedoRaw99_g17548 = (temp_output_51_0_g17548).rgb;
				half3 Main_AlbedoColored863_g17548 = Main_AlbedoRaw99_g17548;
				float2 lerpResult1545_g17548 = lerp( packedInput.ase_texcoord7.xy , packedInput.interp03.xy , _DetailCoordMode);
				float2 Second_UVs17_g17548 = ( ( lerpResult1545_g17548 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo153_g17548 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g17548 ) )).rgb;
				half3 Second_AlbedoColored1963_g17548 = Second_Albedo153_g17548;
				half Mesh_DetailMask90_g17548 = packedInput.ase_color.b;
...
/*ASEBEGIN
Version=18103
1927;1;1906;1021;2886.428;508.495;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;334;-2176,-128;Inherit;False;Base Shader;1;;17548;856f7164d1c579d43a5cf4968a75ca43;51,1271,1,1300,1,1298,1,1962,0,1708,0,1712,0,1964,1,1969,1,1723,0,1719,0,893,0,1745,0,1742,0,1714,1,1718,1,1715,1,1717,1,1728,1,1732,1,916,1,1949,1,1762,1,1763,1,1776,0,1966,1,1736,1,1735,1,1734,1,1737,1,1968,1,1733,1,878,1,1550,1,1646,0,1690,0,1757,0,1669,0,1981,0,1759,0,860,0,2055,1,2031,1,2054,1,2032,1,2057,1,2033,1,2036,1,2060,1,2039,1,2062,1,1785,1;0;14;FLOAT3;0;FLOAT3;528;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;352;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;349;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;347;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;345;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;353;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;True;0;True;-28;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;350;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;True;1;False;-1;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;348;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;351;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;346;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;344;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;343;-1376,-128;Float;False;True;-1;2;TVEShaderCoreGUI;0;2;BOXOPHOBIC/The Vegetation Engine/Objects/Prop Standard Lit;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;1;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;0;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;1;LOD CrossFade;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;0;0;11;True;True;True;True;True;False;False;False;False;False;True;False;;0
...
WireConnection;343;1;334;528
WireConnection;343;4;334;529
WireConnection;343;7;334;530
WireConnection;343;8;334;531
WireConnection;343;9;334;532
WireConnection;343;10;334;653
WireConnection;343;11;334;534
ASEEND*/
//CHKSM=4EF840274D6B9D298CE46A62C6F08AB249356357