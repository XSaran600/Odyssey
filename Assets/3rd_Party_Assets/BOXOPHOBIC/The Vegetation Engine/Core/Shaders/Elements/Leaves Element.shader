...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Leaves Element"
{
	Properties
	{
		...
		[StyledMessage(Info, Use the Leaves elements to reduce the leaves amount on any vegetation. Useful to create winter sceneries or dead forests., 0,0)]_Message1("Message", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 temp_cast_0 = (( _IsHDPipeline * 0.0 )).xxx;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 tex2DNode17_g36 = tex2D( _MainTex, ( ( packedInput.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw ) );
				...
				half Element_Intensity56_g36 = ( _ElementIntensity * packedInput.ase_color.a );
				float lerpResult182_g36 = lerp( 1.0 , Base_Extras_RGB213_g36 , Element_Intensity56_g36);
				float temp_output_9_0_g78 = lerpResult182_g36;
				half sRGB8_g78 = temp_output_9_0_g78;
				half localGammaToLinearFloatFast8_g78 = GammaToLinearFloatFast( sRGB8_g78 );
				float3 appendResult209_g36 = (float3(localGammaToLinearFloatFast8_g78 , 0.0 , 0.0));
				half3 Final_Leaves_RGB210_g36 = appendResult209_g36;
				
				half Final_Leaves_A211_g36 = MainTex_R73_g36;
				
				surfaceDescription.Color = Final_Leaves_RGB210_g36;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = Final_Leaves_A211_g36;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				half Value_Main157_g36 = _MainValue;
				float4 tex2DNode17_g36 = tex2D( _MainTex, ( ( packedInput.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw ) );
				half MainTex_R73_g36 = tex2DNode17_g36.r;
				half TVE_SeasonOptions_X50_g36 = TVE_SeasonOptions.x;
				half Value_Winter158_g36 = _WinterValue;
				half Value_Spring159_g36 = _SpringValue;
...
/*ASEBEGIN
Version=18102
1927;7;1906;1015;1242.756;1848.396;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;72;-640,-1536;Inherit;False;Property;_SeasonMode;Size Mode;33;2;[HideInInspector];[Enum];Create;False;2;Simple;0;Seasons;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-192,-1664;Inherit;False;Property;_Spring;Spring Amount;37;1;[HideInInspector];Create;False;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-640,-1664;Inherit;False;Property;_Simple;Simple Amount;34;1;[HideInInspector];Create;False;0;0;True;1;Space(10);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-640,-1280;Half;False;Property;_Banner1;Banner;0;0;Create;True;0;0;True;1;StyledBanner(Leaves Element);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;77;208,-1664;Inherit;False;Property;_Autumn;Autumn Amount;38;1;[HideInInspector];Create;False;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;-192,-1280;Half;False;Property;_Message1;Message;1;0;Create;True;0;0;True;1;StyledMessage(Info, Use the Leaves elements to reduce the leaves amount on any vegetation. Useful to create winter sceneries or dead forests., 0,0);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;102;-640,-1152;Inherit;False;Base Element;2;;36;0e972c73cae2ee54ea51acc9738801d0;2,145,2,148,2;0;4;FLOAT3;0;FLOAT;86;FLOAT;435;FLOAT;339
Node;AmplifyShaderEditor.RangedFloatNode;103;-448,-1280;Half;False;Property;_IsExtrasShader;_IsExtrasShader;39;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-480,-1536;Inherit;False;Property;_Intensity;Intensity;32;1;[HideInInspector];Create;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-384,-1664;Inherit;False;Property;_Winter;Winter Amount;35;1;[HideInInspector];Create;False;0;0;True;1;Space(10);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;0,-1664;Inherit;False;Property;_Summer;Summer Amount;36;1;[HideInInspector];Create;False;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;109;-256,-1152;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;111;-256,-1152;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;True;0;True;-26;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;110;-256,-1152;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;105;-256,-1152;Float;False;True;-1;2;TVEShaderElementGUI;0;12;BOXOPHOBIC/The Vegetation Engine/Elements/Leaves Element;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;0;True;2;5;False;-20;10;False;-21;0;0;True;-22;0;True;-23;False;False;True;0;False;-26;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-24;True;0;False;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;0;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;0;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;0;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;0;DOTS Instancing;1;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;False;True;True;False;False;False;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;106;-256,-1152;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;107;-256,-1152;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;108;-256,-1152;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.CommentaryNode;94;-640,-1792;Inherit;False;1023.236;100;Legacy;0;;1,0.252,0,1;0;0
WireConnection;105;0;102;0
WireConnection;105;2;102;86
WireConnection;105;6;102;339
ASEEND*/
//CHKSM=BF3F50439F56FC423F9D56E647E42BEE6BB5B204