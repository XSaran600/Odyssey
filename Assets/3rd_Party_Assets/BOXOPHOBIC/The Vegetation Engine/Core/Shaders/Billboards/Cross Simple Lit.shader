	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 VertexPos40_g18336 = inputMesh.positionOS;
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g18353 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g18353 = ( localObjectPosition_UNITY_MATRIX_M14_g18353 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g18353 = localObjectPosition_UNITY_MATRIX_M14_g18353;
				#endif
				half3 ObjectData20_g18355 = staticSwitch13_g18353;
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g18331 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g18331 = ( localObjectPosition_UNITY_MATRIX_M14_g18331 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g18331 = localObjectPosition_UNITY_MATRIX_M14_g18331;
				#endif
				half3 ObjectData20_g18330 = staticSwitch13_g18331;
				...
				float temp_output_349_0_g18313 = ( _MotionVariation_10 * inputMesh.ase_color.r );
				float3 localObjectPosition_UNITY_MATRIX_M14_g18317 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g18317 = ( localObjectPosition_UNITY_MATRIX_M14_g18317 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g18317 = localObjectPosition_UNITY_MATRIX_M14_g18317;
				#endif
				float3 break9_g18317 = staticSwitch13_g18317;
				...
				half Mesh_Motion_182_g18312 = inputMesh.ase_texcoord3.x;
				...
				float3 Vertex_Motion_Object833_g18312 = ( VertexPosRotationAxis50_g18344 + ( VertexPosOtherAxis82_g18344 * cos( Angle44_g18344 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g18344 ) * sin( Angle44_g18344 ) ) );
				...
				float3 Vertex_Motion_World1118_g18312 = ( inputMesh.positionOS + appendResult2043_g18312 );
				...
				#endif
				float3 localObjectPosition_UNITY_MATRIX_M14_g18337 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g18337 = ( localObjectPosition_UNITY_MATRIX_M14_g18337 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g18337 = localObjectPosition_UNITY_MATRIX_M14_g18337;
				#endif
				...
				float lerpResult348_g18312 = lerp( 1.0 , saturate( ( ( distance( _WorldSpaceCameraPos , staticSwitch13_g18337 ) - temp_output_7_0_g18332 ) / ( Global_SizeFadeStart276_g18312 - temp_output_7_0_g18332 ) ) ) , _GlobalSizeFade);
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g18361 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g18361 = ( localObjectPosition_UNITY_MATRIX_M14_g18361 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g18361 = localObjectPosition_UNITY_MATRIX_M14_g18361;
				#endif
				half3 ObjectData20_g18362 = staticSwitch13_g18361;
				...
				float3 Final_Vertex890_g18312 = ( ( staticSwitch14_g18335 * Vertex_SizeFade1740_g18312 * Vertex_Size1741_g18312 ) + ( _IsHDPipeline * 0.0 ) );
						...
						)
			{
				...
				float2 Main_UVs15_g18312 = ( ( packedInput.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g18350 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g18350 = ( localObjectPosition_UNITY_MATRIX_M14_g18350 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g18350 = localObjectPosition_UNITY_MATRIX_M14_g18350;
				#endif
				half3 ObjectData20_g18349 = staticSwitch13_g18350;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				half3 WorldData19_g18349 = ase_worldPos;
				#ifdef MATERIAL_USE_WORLD_DATA
				...
				float3 lerpResult108_g18312 = lerp( temp_cast_0 , ( Global_ColorsTex_RGB1700_g18312 * 4.594794 ) , ( _GlobalColors * packedInput.ase_color.a ));
				...
				half Subsurface_Mask1557_g18312 = 1.0;
				...
				float3 normalizeResult1983_g18312 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float dotResult785_g18312 = dot( -SafeNormalize(-_DirectionalLightDatas[0].forward) , normalizeResult1983_g18312 );
				...
				half3 Subsurface_Deferred1693_g18312 = ( Subsurface_Transmission884_g18312 * Mask_Subsurface_View782_g18312 );
				half3 Blend_AlbedoAndSubsurface149_g18312 = ( Blend_Albedo265_g18312 + Subsurface_Deferred1693_g18312 );
				...
				half Overlay_Commons1365_g18312 = temp_output_1025_0_g18312;
				half Overlay_Mask269_g18312 = saturate( ( saturate( ( packedInput.ase_color.a + ( worldNormal1085_g18312.y * Overlay_Contrast1405_g18312 ) ) ) - ( 1.0 - Overlay_Commons1365_g18312 ) ) );
				...
				float3 switchResult12_g18363 = (((isFrontFace>0)?(temp_output_13_0_g18363):(( temp_output_13_0_g18363 * _render_normals_options ))));
				...
				float lerpResult1037_g18312 = lerp( _ObjectSmoothnessValue , saturate( ( _ObjectSmoothnessValue + Global_Wetness1016_g18312 ) ) , Global_ExtrasTex_A1033_g18312);
				
				float localCustomAlphaClip9_g18340 = ( 0.0 );
				half Main_AlphaRaw1203_g18312 = tex2DNode29_g18312.a;
				half Alpha5_g18340 = Main_AlphaRaw1203_g18312;
				...
				surfaceDescription.Albedo = ( Final_Albedo359_g18312 * Final_Premultiply355_g18312 );
				surfaceDescription.Normal = Final_Normal366_g18312;
				...
				surfaceDescription.Smoothness = lerpResult1037_g18312;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = Main_Alpha316_g18312;

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = Final_Clip914_g18312;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 Main_UVs15_g18312 = ( ( packedInput.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g18312 = tex2D( _MainAlbedoTex, Main_UVs15_g18312 );
				float4 temp_output_51_0_g18312 = ( _MainColor * tex2DNode29_g18312 );
				half3 Main_AlbedoRaw99_g18312 = (temp_output_51_0_g18312).rgb;
				float3 temp_cast_0 = (1.0).xxx;
		...
		Pass
		{
					...
					)
			{
				...
				float2 Main_UVs15_g18312 = ( ( packedInput.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g18312 = tex2D( _MainAlbedoTex, Main_UVs15_g18312 );
				float4 temp_output_51_0_g18312 = ( _MainColor * tex2DNode29_g18312 );
				half Main_Alpha316_g18312 = (temp_output_51_0_g18312).a;
		...
		Pass
		{
					...
					)
			{
				...
				float2 Main_UVs15_g18312 = ( ( packedInput.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode117_g18312 = tex2D( _MainNormalTex, Main_UVs15_g18312 );
				float2 appendResult88_g18364 = (float2(tex2DNode117_g18312.a , tex2DNode117_g18312.g));
				float2 temp_output_90_0_g18364 = ( (appendResult88_g18364*2.0 + -1.0) * _MainNormalValue );
				float3 appendResult91_g18364 = (float3(temp_output_90_0_g18364 , 1.0));
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 Main_UVs15_g18312 = ( ( packedInput.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g18312 = tex2D( _MainAlbedoTex, Main_UVs15_g18312 );
				float4 temp_output_51_0_g18312 = ( _MainColor * tex2DNode29_g18312 );
				half3 Main_AlbedoRaw99_g18312 = (temp_output_51_0_g18312).rgb;
				float3 temp_cast_0 = (1.0).xxx;
...
/*ASEBEGIN
Version=18103
1927;1;1906;1021;2750.556;444.012;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;182;-2175,-128;Inherit;False;Base Shader;1;;18312;856f7164d1c579d43a5cf4968a75ca43;51,1271,0,1300,0,1298,0,1962,1,1708,1,1712,2,1964,1,1969,1,1723,1,1719,1,893,0,1745,1,1742,1,1714,1,1718,1,1715,1,1717,1,1728,1,1732,0,916,0,1949,1,1762,0,1763,0,1776,0,1966,0,1736,0,1735,0,1734,0,1737,0,1968,0,1733,0,878,0,1550,0,1646,1,1690,1,1757,0,1669,0,1981,0,1759,0,860,1,2055,1,2031,1,2054,0,2032,0,2057,0,2033,0,2036,0,2060,0,2039,0,2062,0,1785,1;0;14;FLOAT3;0;FLOAT3;528;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
Node;AmplifyShaderEditor.RangedFloatNode;81;-1920,-896;Half;False;Property;_IsCrossShader;_IsCrossShader;150;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-1344,-896;Half;False;Property;_IsAnyPathShader;_IsAnyPathShader;149;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-1536,-896;Half;False;Property;_IsLitShader;_IsLitShader;148;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;181;-2176,256;Inherit;False;Base Batching;144;;18311;d914b3a554b05ab4da8c1d2a8ce94c0a;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-1728,-896;Half;False;Property;_IsSimpleShader;_IsSimpleShader;147;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;185;-1376,-128;Float;False;True;-1;2;TVEShaderCoreGUI;0;2;BOXOPHOBIC/The Vegetation Engine/Billboards/Cross Simple Lit;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;1;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;0;Receives SSR;0;Motion Vectors;0;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;0;Override Baked GI;0;Depth Offset;0;DOTS Instancing;1;LOD CrossFade;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;0;0;11;True;True;True;True;True;False;False;False;False;False;True;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;189;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;186;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;195;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;True;0;True;-28;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;194;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;191;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;192;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;True;1;False;-1;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;190;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;188;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;193;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;187;-1376,-128;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;177;-2176,-640;Inherit;False;1026.438;100;Features;0;;1,0.252,0,1;0;0
WireConnection;185;0;182;0
WireConnection;185;1;182;528
WireConnection;185;7;182;530
WireConnection;185;9;182;532
WireConnection;185;10;182;653
WireConnection;185;11;182;534
ASEEND*/
//CHKSM=12E365F14F7F95683E6EDC6AAE6A692212BB3091